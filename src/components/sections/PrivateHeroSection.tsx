...
export default async function PrivateHeroSection({ posts }: Props) {
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        >
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <p className="text-lg mb-2" style={{ color: CURRENT_THEME.text }}>
              {profile.university}
            </p>
            <p className="text-lg mb-4" style={{ color: CURRENT_THEME.text }}>
              {profile.major}
            </p>
            <div>
              <h2
          ...
          <TsurezureCard posts={posts} variant="private" />
        </div>
      </div>
    </section>
  );
